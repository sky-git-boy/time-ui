<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" style="margin-bottom: 8px;">
      ...
      <el-col :span="1.5">
        <el-button :disabled="single" type="warning" icon="el-icon-thumb" size="mini" @click="handleSelectMenu">分配权限</el-button>
      </el-col>
    </el-row>
    <!-- 表格工具按钮结束 -->

    <!-- 数据表格开始 -->
    <el-table v-loading="loading" :data="roleTableList" border @selection-change="handleSelectionChange">
      ...
      <el-table-column :formatter="statusFormatter" label="状态" width="110" prop="status" align="center" />
  ...
  data() {
    return {
      ...
      rules: {
        ...
        roleCode: [{ required: true, message: '权限编码不能为空', trigger: 'blur' }]
      },
      // 是否打开分配权限的弹出层
