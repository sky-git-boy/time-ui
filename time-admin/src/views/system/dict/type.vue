<template>
  <div class="app-container">
    ...
    <!-- 数据表格开始 -->
    <el-table v-loading="loading" :data="dictTypeTableList" border @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="编号" prop="dictId" align="center" />
      <el-table-column :show-overflow-tooltip="true" label="字典名称" prop="dictName" align="center" />
      <el-table-column :show-overflow-tooltip="true" label="字典类型" prop="dictType" align="center">
        <template slot-scope="scope">
          <router-link :to="'/dict/data/' + scope.row.dictId" class="link-type">
            <span style="color:RGB(64,158,255);">{{ scope.row.dictType }}</span>
          </router-link>
        </template>
      </el-table-column>
      <el-table-column :formatter="statusFormatter" label="状态" prop="status" align="center" />
      <el-table-column :show-overflow-tooltip="true" label="备注" prop="remark" align="center" />
