<template>
  <div class="app-container">
    ...
    <!-- 数据表格开始 -->
    <el-table v-loading="loading" :data="dictDataTableList" border @selection-change="handleSelectionChange">
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="排序显示" prop="dictSort">
          <el-input-number v-model="form.dictSort" :min="0" placeholder="请输入数据键值" clearable size="small" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
