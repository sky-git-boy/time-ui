<template>
  <div class="app-container">
    ...
    <!-- 表头按钮结束 -->
    <!-- 数据表格开始 -->
    <el-table v-loading="loading" :data="operLogTableList" border @selection-change="handleSelectionChange">
      ...
      <el-table-column :formatter="businessTypeFormatter" label="操作类型" align="center" prop="businessType" />
