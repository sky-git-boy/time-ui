<template>
  <div class="app-container">
    ...
    <!-- 表头按钮结束 -->
    <!-- 数据表格开始 -->
    <el-table v-loading="loading" :data="smsTableList" border @selection-change="handleSelectionChange">
      ...
      <el-table-column :formatter="statusFormatter" label="发送状态" prop="status" align="center" />
...
export default {
  ...
  created() {
    // 查询条件的状态
    this.getDataByType('sys_sms_status').then(res => {
