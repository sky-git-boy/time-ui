<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="noticeTableList" border @selection-change="handleSelectionChange">
      ...
      <el-table-column :formatter="noticeTypeFormatter" label="类型" prop="noticeType" align="center" width="125px" />
...
export default {
  ...
  data() {
    return {
      ...
      // 表单校验
      rules: {
        noticeTitle: [{ required: true, message: '通知公告标题不能为空', trigger: 'blur' }]
      },
      // 查看内容的弹出层
